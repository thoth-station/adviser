        ...
        if isinstance(match, list):
            for item in match:
                yield {
                    ...
                    "multi_package_resolution": unit_prescription.get("multi_package_resolution", False),
                }
        else:
            yield {
                "package_name": match["package_version"].get("name"),
                "multi_package_resolution": unit_prescription["run"].get("multi_package_resolution", False),
            }
