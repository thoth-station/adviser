...
"""Test a wrap that notifies a bug in the tf.keras.Embedding layer."""
...
from thoth.adviser.wraps import TensorFlowSlowKerasEmbedding
...
class TestIntelTensorflowWrap(AdviserUnitTestCase):
    ...
    UNIT_TESTED = TensorFlowSlowKerasEmbedding
