...
class TestTemporalDifference(AdviserTestCase):
    ...
    def test_set_reward_signal_unseen(self) -> None:
        ...
        predictor = TemporalDifference()
        predictor._policy = {("numpy", "1.0.0", "https://pypi.org/simple"): [30.30, 92]}
    ...
    def test_set_reward_signal_seen(self) -> None:
        ...
        predictor = TemporalDifference()
        predictor._policy = {package_tuple: [16.23, 2010], ("numpy", "1.0.0", "https://pypi.org/simple"): [30.30, 92]}
    ...
    def test_run_exploration(self, context: Context) -> None:
        ...
        unresolved_dependency = ("pytorch", "1.0.0", "https://thoth-station.ninja/simple")
