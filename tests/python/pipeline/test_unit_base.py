...
from thoth.adviser.python.pipeline.unit_base import PipelineUnitBase

from base import AdviserTestCase


class TestPipelineUnitBase(AdviserTestCase):
    ...
    def test_is_aicoe_release(self, package_version, expected):
        """Test checking if the given package is an AICoE package."""
        assert PipelineUnitBase.is_aicoe_release(package_version) is expected
    ...
    def test_get_aicoe_configuration(self, package_version, expected):
        ...
        assert PipelineUnitBase.get_aicoe_configuration(package_version) == expected
