...
class TestImportlibResourcesBackportSieve(AdviserUnitTestCase):
    ...
    UNIT_TESTED = ImportlibResourcesBackportSieve
    ...
    def test_should_include(
        ...
        assert list(ImportlibResourcesBackportSieve.should_include(builder_context)) == [{}]
    ...
    def test_remove(self, context: Context) -> None:
        ...
        with ImportlibResourcesBackportSieve.assigned_context(context):
