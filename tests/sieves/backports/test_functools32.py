...
class TestFunctools32BackportSieve(AdviserUnitTestCase):
    """Test sieve removing functools32 backport."""

    UNIT_TESTED = Functools32BackportSieve

    def test_verify_multiple_should_include(self, builder_context: PipelineBuilderContext) -> None:
        """Verify multiple should_include calls do not loop endlessly."""
        builder_context.recommendation_type = RecommendationType.LATEST
        builder_context.project.runtime_environment.python_version = "3.7"
    ...
    def test_should_include(
        ...
        assert list(Functools32BackportSieve.should_include(builder_context)) == [{}]
