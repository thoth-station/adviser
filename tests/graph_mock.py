            ...
            for version_entry in info_entry:
                for depends_on_entry in version_entry.get("depends_on", []):
                    for version in depends_on_entry["resolved"]:
                        queue.append([depends_on_entry["package_name"], version, depends_on_entry["index_url"]])
                        ...
                        destination = (depends_on_entry["package_name"], version, depends_on_entry["index_url"])
